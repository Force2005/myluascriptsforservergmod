...
local AllowWeaponsInSeat = CreateConVar("sitting_allow_weapons_in_seat","1",{FCVAR_ARCHIVE}, "Allows the use of weapons in SitAnywhere sitting", 0, 1)
local AdminOnly = CreateConVar("sitting_admin_only","0",{FCVAR_ARCHIVE}, "Locks sitting to admins only (uses PLAYER:IsAdmin)", 0, 1)
local AntiPropSurf = CreateConVar("sitting_anti_prop_surf","0",{FCVAR_ARCHIVE}, "Disables the use of the physgun on contraptions with someone sitting on them", 0, 1)
local AntiToolAbuse = CreateConVar("sitting_anti_tool_abuse","0",{FCVAR_ARCHIVE}, "Disables the use of the toolgun on contraptions with someone sitting on them", 0, 1)
